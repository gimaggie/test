...
import java.net.MalformedURLException;
    ...
    public class AppiumTestN {
        ...
        public void testUntitled() {
            ...
            driver.findElement(By.xpath("//*[@text and @class='android.widget.EditText']")).sendKeys("company");
            new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//*[@class='android.widget.LinearLayout' and ./parent::*[@class='android.widget.ScrollView']]/*/*[@class='android.widget.EditText'])[2]")));
